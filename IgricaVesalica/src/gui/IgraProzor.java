...
public class IgraProzor extends JFrame {
	...
	public IgraProzor() {
		...
		JLabel lblBrojGresaka = new JLabel("0");
		lblBrojGresaka.setBounds(388, 269, 46, 14);
		contentPane.add(lblBrojGresaka);
		...
		try {
			...
			JLabel lblGreske = new JLabel("GRESKE:");
			lblGreske.setBounds(302, 268, 62, 14);
			contentPane.add(lblGreske);
		...
		btnE.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblBrojGresaka.setText(GUIKontroler.brojGresaka()+"");
